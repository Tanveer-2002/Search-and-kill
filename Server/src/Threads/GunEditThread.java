...
public class GunEditThread implements Runnable {
    ...
    public GunEditThread(String playerinfo, ObjectOutputStream oos,ObjectInputStream ois){
    ...
    public void run(){
        ...
        try{
            ...
            Server.allConnectedPlayerList.get(playerIndex).setGun(infos[3]);
